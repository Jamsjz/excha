        ...
        <>
            ...
            <div className="flex sm:hidden flex-col items-center justify-center mx-4">
                <div className="font-bold text-center flex items-center justify-center my-7 text-[#C8D208] text-[28px] font-canva">
                    <p>
                        ...
                        <span className="font-bold ml-2 text-[#D69C9C]">EXCHA</span>nge away.
                    </p>
                </div>
                <div className="flex flex-col items-center justify-center">
                    <button className="bg-[#5CE1E6] text-[#13171F] text-[18px] rounded-full px-4 py-2 font-extrabold font-canva">
                        <Link href={route('register')} className="hover:underline">Register
                        </Link> /
                        <Link href={route('login')} className="hover:underline"> Login
                        </Link>
                    </button>
                ...
                <div className="flex  flex-col my-4">
                    <img src="/img/maninchair.png" alt="wow" draggable="false" />
            ...
            <div className="hidden sm:block lg:hidden">
                <div className="flex flex-col   mx-4">
                    ...
                    <div className="flex justify-between ml-14  my-5">
                        ...
                        <img src="/img/maninchair.png" alt="wow" className="w-3/4" draggable="false" />
                    </div>
            ...
            <div className="hidden lg:block ">
                <div className="flex flex-row items-center mx-4 justify-evenly mt-14">
                    {/* left */}
                    <div>
                        <div className=" mt-7 text-[#C8D208] text-[60px] font-bold font-canva">
                            Your next favorite book is an
                            <span className="ml-2 text-[#D69C9C]">
                                EXCHA
                            </span>ange away.
                        </div>
                    ...
                    {/* right */}
                    <div className="">
                        <img src="/img/maninchair.png" alt="wow" className="w-[900px]" draggable="false" />
                    </div>
                </div>
